...
class Response:
    def __init__(self, data) -> None:
        ...
        self.created = datetime.fromtimestamp(self._data.get('created'))
        ...
        self.media_formats = [Media(i, self._data.get('media_formats')[i]) for i in self._data.get('media_formats')]
